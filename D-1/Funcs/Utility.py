...
PATH_RESULTS = '/var/nfs_share/Overfitting/D-1/Results'

PATH_INTERMEDIATE = '/var/nfs_share/Overfitting/D-1/Intermediate'
PATH_PROC_DATA = '/var/nfs_share/Stress_Detection_D-1/Intermediate/proc.pkl'
RANDOM_STATE =42
